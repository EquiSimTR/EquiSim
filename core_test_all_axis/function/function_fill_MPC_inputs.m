...
% if experiment.phase_type_sampling(k) == "RT"
%      MPC_inputs.dc_ref(:,1)=MPC_inputs.dc_ref(1,1);
%      MPC_inputs.dc_ref(:,2)=MPC_inputs.dc_ref(1,2);
%      
%      MPC_inputs.MoS_sampling(:)=MPC_inputs.MoS_sampling(1);
%      MPC_inputs.no_double_support(:)=MPC_inputs.no_double_support(1);
%      
%      MPC_inputs.MoS_sampling(:)=MPC_inputs.MoS_sampling(1);
%      MPC_inputs.phase_type_sampling(:)=MPC_inputs.phase_type_sampling(1);
% end
...
if experiment.phase_type_sampling(k) == "RT" || experiment.phase_type_sampling(k) == "start"
     MPC_inputs.dc_ref(:,1)=MPC_inputs.dc_ref(1,1);
     MPC_inputs.dc_ref(:,2)=MPC_inputs.dc_ref(1,2); 
end
...
if experiment.phase_type_sampling(k) == "RT" || experiment.phase_type_sampling(k) == "start"
     MPC_inputs.Px_step(:,1)=MPC_inputs.Px_step(1,1);
     MPC_inputs.Px_step(:,2)=MPC_inputs.Px_step(1,2);
     if size(MPC_inputs.Px_step,2)==3
        MPC_inputs.Px_step(:,3)=MPC_inputs.Px_step(1,3); 
     end
end
...
MPC_inputs.MoS_sampling=experiment.MoS_sampling(preview_windows,:); 
if experiment.phase_type_sampling(k) == "RT" || experiment.phase_type_sampling(k) == "start" 
    MPC_inputs.MoS_sampling(:)=MPC_inputs.MoS_sampling(1); 
end 
...
%./
phase_type_sampling=MPC_inputs.phase_type_sampling;
phase_type_sampling(any(phase_type_sampling=='RT',2))='start';
phase_type_sampling(any(phase_type_sampling=='SPT',2))='start';
%./
...
MPC_inputs.phase_type_reduce=phase_type_sampling(([0;MPC_inputs.phase_type_sampling(1:end-1)]==MPC_inputs.phase_type_sampling)==0);
if experiment.phase_type_sampling(k) == "RT" || experiment.phase_type_sampling(k) == "start"   
     MPC_inputs.phase_type_sampling(:)=MPC_inputs.phase_type_sampling(1);
end
...
if MPC_inputs.phase_type_reduce(1)=='b' || MPC_inputs.phase_type_reduce(1)=="start" || MPC_inputs.phase_type_reduce(1)=="stop"|| MPC_inputs.phase_type_reduce(1)=="RT" || MPC_inputs.phase_type_reduce(1)=="SPT"
...
if experiment.phase_type_sampling(k) == "RT" || experiment.phase_type_sampling(k) == "start"   
     MPC_inputs.hcom_ref_max_reduce(:)=MPC_inputs.hcom_ref_max_reduce(1);
end
...
if experiment.phase_type_sampling(k) == "RT" || experiment.phase_type_sampling(k) == "start"   
     MPC_inputs.yaw(:)=MPC_inputs.yaw(1);
end
...
if experiment.phase_type_sampling(k) == "RT" || experiment.phase_type_sampling(k) == "start"   
     MPC_inputs.double_support(:)=MPC_inputs.double_support(1);
end
...
if experiment.phase_type_sampling(k) == "RT" || experiment.phase_type_sampling(k) == "start"   
     MPC_inputs.no_double_support_capture(:)=MPC_inputs.no_double_support_capture(1);
end
end