...
% experiment.phase_duration_sampling(k)=experiment.phase_duration_sampling(k)
% 
% if experiment.phase_type_sampling(k) == "RT"
%      MPC_inputs.dc_ref(:,1)=MPC_inputs.dc_ref(1,1);
%       
...
MoS_sampling=experiment.MoS_sampling(preview_windows,:); 
MPC_inputs.MoS_sampling = MoS_sampling;
