...
xdz=1*MPC_outputs_storage.xdc+0*MPC_outputs_storage.xddc-zeta.*[0;MPC_outputs_storage.xc_control];
ydz=1*MPC_outputs_storage.ydc+0*MPC_outputs_storage.yddc-zeta.*[0;MPC_outputs_storage.yc_control];
